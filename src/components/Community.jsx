...
function Community() {
  return (
    <div className='h-auto w-screen bg-white flex  justify-center gap-x-4'>
        <div className='h-[350px] w-[18vw] flex-col justify-center text-center bg-gradient-to-b from-[#dbc70c] to-transparent rounded-tl-3xl'>
        ...
        <div className='h-[350px] w-[18vw] flex-col justify-center text-center bg-gradient-to-b from-[#00d4d4] to-transparent '>
        ...
        <div className='h-[350px] w-[18vw] flex-col justify-center text-center bg-gradient-to-b from-[#d427ff] to-transparent '>
        ...
        <div className='h-[350px] w-[18vw] flex-col justify-center text-center bg-gradient-to-b from-[#8f3a3c] to-transparent rounded-tr-3xl'>
