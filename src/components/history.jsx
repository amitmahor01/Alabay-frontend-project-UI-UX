...
<div className="bg-[radial-gradient(42.38%_44.19%_at_50.14%_67.33%,_#FFF280_0%,_#FFC700_100%)] w-screen h-[700px]">
  <div className="flex items-center justify-between h-full p-5 w-[60%] ">
    ...
    <div className="flex-1 ml-28 text-right tracking-wider">
      <h1 className="text-[60px] font-extrabold font-Montserrat text-orange-500">History Of</h1>
      <h2 className="text-[120px] font-CheeseBurga font-bold text-[#ffffff] -mt-4 "><span className="tracking-wide">ALABAY</span></h2>
