...
import bgImage from '../images/AlabayGames/Alabayheritageprevgradient.png';

import Preview1 from '../images/AlabayGames/Alabay Adventure - The Lost Heritage/Abilities.png'
import Preview2 from '../images/AlabayGames/Alabay Adventure - The Lost Heritage/artifacts.png'
import Preview3 from '../images/AlabayGames/Alabay Adventure - The Lost Heritage/locations preview.png'
import Preview4 from '../images/AlabayGames/Alabay Adventure - The Lost Heritage/overview.png'



// Main Component
function AlabayLostHeritageScreen() {
    ...
    style={{
      ...
      <div className="relative z-10">
        ...
        <div className="w-screen h-screen flex flex-col justify-center items-start mt-40 ml-20">
          ...
          > 
            <div className="">
            <h1 className="text-white text-[70px] font-bold font-Pattaya">ALABAY HERITAGE</h1>
            <h2 className="text-[#90ffae] text-4xl  md:uppercase">tHE LOST ADVENTURE</h2>
            </div>
          ...
          <div className="flex justify-between space-x-4 text-[30px] font-bold mt-20">
            <h1 className='md:uppercase text-white'><span className='text-[#90ffae]'>Game</span> Previews</h1>
        </div>
        ...
        <div className="relative mt-5">
          ...
          >
            ...
            <div className="w-[250px] h-[250px]  flex items-center justify-center text-xl">
            <img src={Preview4} alt=""  className="rounded-3xl border-2 border-white "/>
            </div>
...
export default AlabayLostHeritageScreen;
